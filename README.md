...
| `multipart_file_type` | `List<int>` | `false` | Using this option, you can set preferred type of multipart data (Can be `String`, if you want to set path to file, or can be `List<int>` if you want use binary data. Can be nullable `String?` |
